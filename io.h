#include "ridesharing.h"//Thomas Kestler : I have avoided modifying this file to not mess up the output
//This file was provided by San Diego State University, I did not write the code in this file
